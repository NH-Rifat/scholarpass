...
import { ControlledMultiSelect, ControlledSelect } from "../RHFFormComponents";
        ...
        <View style={styles.form}>
          <View style={styles.courseSection}>
            ...
            <View style={styles.infoBox}>
              ...
              <Text style={styles.infoText}>
                Don't see your course? Select the closest related field, and
                we'll help match you with relevant scholarships.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.scholarshipSection}>
            ...
            <ControlledMultiSelect
              ...
              options={scholarshipPrograms.map((program) => ({
                label: program.title,
                value: program.id,
              }))}
            />
            ...
            <View style={styles.scholarshipNote}>
              ...
              <View style={styles.noteContent}>
                ...
                <Text style={styles.noteText}>
                  ...
                  scholarship matches for you. You can apply to multiple
                  programs to increase your chances of success.
                </Text>
              </View>
            </View>
          </View>
