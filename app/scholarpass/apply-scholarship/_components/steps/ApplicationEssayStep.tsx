        ...
        <View style={styles.form}>
          <View style={styles.essaySection}>
            ...
            <View style={styles.wordCountContainer}>
              <Text style={[
                styles.wordCount,
                wordCount > 500 ? styles.wordCountGood : styles.wordCountNormal
              ]}>
                {wordCount} words
              </Text>
          ...
          <View style={styles.tipsSection}>
            ...
            <View style={styles.tipItem}>
              ...
              <Text style={styles.tipText}>
                <Text style={styles.tipBold}>Be authentic:</Text> Share your real
                experiences and genuine motivations
              </Text>
            </View>
            ...
            <View style={styles.tipItem}>
              <MaterialIcons name="check-circle" size={16} color="#10B981" />
              <Text style={styles.tipText}>
                <Text style={styles.tipBold}>Show don't tell:</Text> Use specific
            ...
            <View style={styles.tipItem}>
              <MaterialIcons name="check-circle" size={16} color="#10B981" />
              <Text style={styles.tipText}>
                <Text style={styles.tipBold}>Proofread carefully:</Text> Check for
          ...
          <View style={styles.promptsSection}>
            ...
            <View style={styles.promptItem}>
              <Text style={styles.promptText}>
                • How do you plan to give back to your community with your education?
              </Text>
            </View>
          ...
          <View style={styles.finalNote}>
            ...
            <View style={styles.finalNoteContent}>
              ...
              <Text style={styles.finalNoteText}>
                This is the final step of your scholarship application. Take your
                time to craft a thoughtful essay that represents who you are and
                your aspirations. Good luck!
              </Text>
            </View>
          </View>
        </View>
